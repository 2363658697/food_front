		...
		<div id="menu1">
			...
			<div class="menu3">
				<div class="menu3_left">
					<img src="${pageContext.request.contextPath }/image?path=${param.path}"
			...
			<div class="menu4">
				...
				<a href="${pageContext.request.contextPath }/showCart?foodId=${param.foodId }&foodName=${param.foodName }&price=${param.price }" style="background:url(${pageContext.request.contextPath }/detail/style/images/img/order_left_corner_bg.png);">放入餐车</a>
